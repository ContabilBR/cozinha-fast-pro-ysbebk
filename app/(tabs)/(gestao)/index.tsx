...
export default function GestaoScreen() {
  ...
  const canAccess =
    role === "admin" || role === "administrador" || role === "gerente";

  const cards: ManagementCard[] = [
    {
      icon: <UtensilsCrossed size={26} color={COLORS.primary} />,
      title: "Pratos",
    ...
    {
      icon: <LayoutGrid size={26} color="#0EA5E9" />,
      title: "Mesas",
      subtitle: "Gerenciar mesas",
      route: "/(gestao)/mesas",
      color: "#0EA5E9",
    },
  ];
          ...
          {cards.map((card, index) => (
            <View key={card.title} style={{ width: "50%" }}>
              <ManagementCardItem
                ...
                index={index}
                onPress={() => {
                  console.log("[Gestao] Navigate to:", card.route);
